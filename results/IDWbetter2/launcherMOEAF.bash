...
PROBLEM_SETUP="IDWbetter_81c_400m_thr4"  # something useful to characterize this problem setup
ALGORITHMS=( GDE3 ) #eNSGAII GDE3 ) #OMOPSO )
NFE=20000000
SEED_START=1
SEED_END=1
...
do
	...
	do
		...
		if [ ${ALGORITHM} == "GDE3" ]
		then
			java -Xmx3g -cp ../javaLibs/GLEmodelMOEAinterface.jar:../javaLibs/MOEAFramework-1.17-Executable.jar:../javaLibs/snakeyaml-1.11.jar org.andreaEmanuele.MOLEM.GLEExecutorUtility -a ${ALGORITHM} -b GLEmodel -n ${NFE} -p 250 -e 10000.0,100000.0,0.1,0.00001 -d 0.9,0.9 -q ${SEED}.${PROBLEM_SETUP} -c ${PROBLEM_SETUP}.${ALGORITHM}.${SEED}.chkp,1000 -o output.${PROBLEM_SETUP}.${ALGORITHM}.${SEED}.data &> ${PROBLEM_SETUP}.${ALGORITHM}.${SEED}.stdout &
		fi
		sleep 1
	done
done
